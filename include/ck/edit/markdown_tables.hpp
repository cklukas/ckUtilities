...
// surrounding text, including a separator after an adjoining pipe table.
// Dimensions are deliberately bounded so a malformed dialog input cannot
// create an impractically large single document transaction.
