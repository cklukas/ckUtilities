...
> Historical ideation note. Its Turbo Vision references describe the former
> baseline, not the current architecture; see [the ckVision roadmap](tv_to_ckvision.md).
