...
const CommandLabel kDefaultLabels[] = {
    ...
    {commands::find::TogglePreview, "ck-find", "Toggle Preview"},
    {commands::find::TabQuickStart, "ck-find", "Quick Start Tab"},
    {commands::find::TabContentNames, "ck-find", "Content & Names Tab"},
    {commands::find::TabDatesSizes, "ck-find", "Dates & Sizes Tab"},
    {commands::find::TabTypesOwnership, "ck-find", "Types & Ownership Tab"},
    {commands::find::TabTraversal, "ck-find", "Traversal Tab"},
    {commands::find::TabActions, "ck-find", "Actions Tab"},
    {commands::common::TabNext, "", "Next Tab"},
    {commands::common::TabPrevious, "", "Previous Tab"},
...
const CommandHelp kDefaultHelps[] = {
    {cmQuit, "Exit the application."},
    {cmClose, "Close the active window."},
    {cmMenu, "Activate the menu bar."},
    {cmZoom, "Toggle the current window between normal and zoomed size."},
    {cmResize, "Resize or move the active window."},
    {cmNext, "Focus the next open window."},
    {cmTile, "Tile all open windows."},
    {cmCascade, "Cascade all open windows."},
    {cmOpen, "Open a file or document."},
    {cmNew, "Create a new document."},
    {cmChangeDir, "Change the working directory."},
    {cmSave, "Save the current document."},
    {cmSaveAs, "Save the current document under a new name."},
    {cmCopy, "Copy the selection to the clipboard."},
    {cmCut, "Cut the selection to the clipboard."},
    {cmPaste, "Paste the clipboard contents."},
    {cmUndo, "Undo the last action."},
    {cmFind, "Search within the current document."},
    {cmReplace, "Find and replace text in the current document."},
    {cmSearchAgain, "Repeat the last search."},
    {cmHelp, "Show context help."},

    {commands::common::ReturnToLauncher, "Return to the launcher overview."},
    {commands::common::About, "Show application information."},

    {commands::utilities::LaunchTool, "Launch the selected tool."},
    {commands::utilities::ToggleEventViewer, "Show or hide the event viewer."},
    {commands::utilities::NewLauncher, "Open a new launcher window."},
    ...
    {commands::disk_usage::ViewFileTypes, "Group disk usage by file type."},
    {commands::disk_usage::ViewFileTypesRecursive, "Group disk usage by type including subdirectories."},
    {commands::disk_usage::SortUnsorted, "Clear sorting and use the default order."},
    {commands::disk_usage::SortNameAsc, "Sort entries by name ascending."},
    {commands::disk_usage::SortNameDesc, "Sort entries by name descending."},
    {commands::disk_usage::SortSizeDesc, "Sort entries by size descending."},
    {commands::disk_usage::SortSizeAsc, "Sort entries by size ascending."},
    {commands::disk_usage::SortModifiedDesc, "Sort entries by last modified time descending."},
    {commands::disk_usage::SortModifiedAsc, "Sort entries by last modified time ascending."},
    {commands::disk_usage::OptionFollowNever, "Disable following symbolic links."},
    {commands::disk_usage::OptionFollowCommandLine, "Follow only symbolic links supplied on the command line."},
    {commands::disk_usage::OptionFollowAll, "Follow all symbolic links."},
    {commands::disk_usage::OptionToggleHardLinks, "Toggle counting of hard linked files."},
    {commands::disk_usage::OptionToggleNodump, "Toggle honoring the nodump file flag."},
    {commands::disk_usage::OptionToggleErrors, "Toggle display of filesystem errors."},
    {commands::disk_usage::OptionToggleOneFs, "Toggle staying on the starting filesystem."},
    {commands::disk_usage::OptionEditIgnores, "Edit the ignore pattern list."},
    {commands::disk_usage::OptionEditThreshold, "Adjust the minimum size threshold."},
    {commands::disk_usage::OptionLoad, "Load disk usage options from a file."},
    {commands::disk_usage::OptionSave, "Save the current disk usage options."},
    {commands::disk_usage::OptionSaveDefaults, "Save the current options as defaults."},

    {commands::config::ReloadApps, "Reload application definitions."},
    {commands::config::EditApp, "Edit the selected application's options."},
    {commands::config::ResetApp, "Reset the selected application's configuration."},
    {commands::config::ClearApp, "Remove stored defaults for the selected application."},
    {commands::config::ExportApp, "Export the application's configuration."},
    {commands::config::ImportApp, "Import application configuration from a file."},
    {commands::config::OpenConfigDir, "Open the configuration directory."},

    {commands::find::NewSearch, "Start a new search definition."},
    {commands::find::LoadSpec, "Load a saved search specification."},
    {commands::find::SaveSpec, "Save the current search specification."},
    {commands::find::BrowseStart, "Choose a starting directory."},
    {commands::find::TextOptions, "Edit text matching options."},
    {commands::find::NamePathOptions, "Edit name and path filters."},
    {commands::find::TimeFilters, "Adjust time-based filters."},
    {commands::find::SizeFilters, "Adjust size-based filters."},
    {commands::find::TypeFilters, "Choose file type filters."},
    {commands::find::PermissionOwnership, "Set permission and ownership filters."},
    {commands::find::TraversalFilters, "Configure traversal options."},
    {commands::find::ActionOptions, "Configure actions for matching files."},
    ...
    {commands::find::TabTypesOwnership, "Switch to the Types & Ownership tab."},
    {commands::find::TabTraversal, "Switch to the Traversal tab."},
    {commands::find::TabActions, "Switch to the Actions tab."},
    {commands::common::TabNext, "Move to the next tab."},
    {commands::common::TabPrevious, "Move to the previous tab."},

    {commands::json_view::Find, "Search within the JSON tree."},
    {commands::json_view::FindNext, "Move to the next search match."},
    {commands::json_view::FindPrev, "Move to the previous search match."},
    {commands::json_view::EndSearch, "Clear the current search."},
    {commands::json_view::Level0, "Collapse all nodes."},
    {commands::json_view::Level1, "Expand nodes to depth 1."},
    {commands::json_view::Level2, "Expand nodes to depth 2."},
    {commands::json_view::Level3, "Expand nodes to depth 3."},
    {commands::json_view::Level4, "Expand nodes to depth 4."},
    {commands::json_view::Level5, "Expand nodes to depth 5."},
    {commands::json_view::Level6, "Expand nodes to depth 6."},
    {commands::json_view::Level7, "Expand nodes to depth 7."},
    {commands::json_view::Level8, "Expand nodes to depth 8."},
    {commands::json_view::Level9, "Expand nodes to depth 9."},

    {commands::chat::NewChat, "Start a new chat session."},
    {commands::chat::ManageModels, "Open the model management dialog."},
    {commands::chat::ManagePrompts, "Open the prompt management dialog."},
    {commands::chat::SendPrompt, "Send the current prompt."},
    {commands::chat::ShowThinking, "Show the assistant's thinking."},
    {commands::chat::HideThinking, "Hide the assistant's thinking."},
    {commands::chat::ShowAnalysis, "Show analysis messages."},
    {commands::chat::HideAnalysis, "Hide analysis messages."},
    {commands::chat::CopyLastResponse, "Copy the last response to the clipboard."},

    {commands::edit::cmToggleWrap, "Toggle line wrapping."},
    {commands::edit::cmToggleMarkdownMode, "Toggle Markdown rendering."},
    {commands::edit::cmHeading1, "Apply Heading 1 formatting."},
    {commands::edit::cmHeading2, "Apply Heading 2 formatting."},
    {commands::edit::cmHeading3, "Apply Heading 3 formatting."},
    {commands::edit::cmHeading4, "Apply Heading 4 formatting."},
    {commands::edit::cmHeading5, "Apply Heading 5 formatting."},
    {commands::edit::cmHeading6, "Apply Heading 6 formatting."},
    {commands::edit::cmClearHeading, "Remove heading formatting."},
    {commands::edit::cmMakeParagraph, "Convert the selection to a paragraph."},
    {commands::edit::cmInsertLineBreak, "Insert a line break."},
    {commands::edit::cmBold, "Apply bold formatting."},
    {commands::edit::cmItalic, "Apply italic formatting."},
    {commands::edit::cmBoldItalic, "Apply bold and italic formatting."},
    {commands::edit::cmStrikethrough, "Apply strikethrough formatting."},
    {commands::edit::cmInlineCode, "Format the selection as inline code."},
    {commands::edit::cmCodeBlock, "Insert or toggle a code block."},
    {commands::edit::cmRemoveFormatting, "Clear formatting from the selection."},
    {commands::edit::cmToggleBlockQuote, "Toggle block quote formatting."},
    {commands::edit::cmToggleBulletList, "Toggle a bullet list."},
    {commands::edit::cmToggleNumberedList, "Toggle a numbered list."},
    {commands::edit::cmConvertTaskList, "Convert the list to a task list."},
    {commands::edit::cmToggleTaskCheckbox, "Toggle the task checkbox."},
    {commands::edit::cmIncreaseIndent, "Increase indentation."},
    {commands::edit::cmDecreaseIndent, "Decrease indentation."},
    {commands::edit::cmDefinitionList, "Convert the selection to a definition list."},
    {commands::edit::cmToggleSmartList, "Toggle automatic list continuation."},
    {commands::edit::cmInsertLink, "Insert a link."},
    {commands::edit::cmInsertReferenceLink, "Insert a reference-style link."},
    {commands::edit::cmAutoLinkSelection, "Automatically link the selection."},
    {commands::edit::cmInsertImage, "Insert an image reference."},
    {commands::edit::cmInsertFootnote, "Insert a footnote."},
    {commands::edit::cmInsertHorizontalRule, "Insert a horizontal rule."},
    {commands::edit::cmEscapeSelection, "Escape Markdown formatting in the selection."},
    {commands::edit::cmInsertTable, "Insert a Markdown table."},
    {commands::edit::cmTableInsertRowAbove, "Insert a table row above the current row."},
    {commands::edit::cmTableInsertRowBelow, "Insert a table row below the current row."},
    {commands::edit::cmTableDeleteRow, "Delete the current table row."},
    {commands::edit::cmTableInsertColumnBefore, "Insert a table column before the current one."},
    {commands::edit::cmTableInsertColumnAfter, "Insert a table column after the current one."},
    {commands::edit::cmTableDeleteColumn, "Delete the current table column."},
    {commands::edit::cmTableDeleteTable, "Delete the table."},
    {commands::edit::cmTableAlignDefault, "Apply default column alignment."},
    {commands::edit::cmTableAlignLeft, "Align column contents to the left."},
    {commands::edit::cmTableAlignCenter, "Align column contents to the center."},
    {commands::edit::cmTableAlignRight, "Align column contents to the right."},
    {commands::edit::cmTableAlignNumber, "Align column contents for numbers."},
    {commands::edit::cmReflowParagraphs, "Reflow the selected paragraphs."},
    {commands::edit::cmFormatDocument, "Format the entire document."},
};
...
const KeyBinding kLinuxBindings[] = {
    ...
    {commands::find::TogglePreview, TKey(kbCtrlP), "Ctrl-P"},
    {commands::find::TabQuickStart, TKey(kbAlt1), "Alt-1"},
    {commands::find::TabContentNames, TKey(kbAlt2), "Alt-2"},
    {commands::find::TabDatesSizes, TKey(kbAlt3), "Alt-3"},
    {commands::find::TabTypesOwnership, TKey(kbAlt4), "Alt-4"},
    {commands::find::TabTraversal, TKey(kbAlt5), "Alt-5"},
    {commands::find::TabActions, TKey(kbAlt6), "Alt-6"},
...
void registerBuiltinHotkeySchemes()
{
    ...
    registerCommandHelps(std::span<const CommandHelp>(kDefaultHelps));
