...
// Native registry inspector/editor. Persistence is deliberately outside this
// view: callers inject the registry and decide when its changes are saved.
class ConfigApp
{
public:
    ConfigApp(ckv::ui::Application &application, ck::config::OptionRegistry &registry);
    ~ConfigApp();
