...
| Edit | `ck-edit-ckvision` | native document open/save/save-as, dirty Save/Discard/Cancel close, Markdown syntax profile, transactional whitespace normalization, bold/italic/strikethrough/delimiter-safe inline-code selection toggles, heading 1–6 toggles that protect code, Unicode selection restoration, and explicit external-save-conflict recovery | lists/links/reflow/smart-list/find-replace transformations, final acceptance |
