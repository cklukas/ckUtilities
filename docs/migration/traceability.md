...
| CV-GAP-002 | A long streaming rich-text document may need active-block updates, bottom anchoring, selection/copy, and bounded relayout. | CKU-CHAT | ckUtilities now bounds the live transcript and coalesces small response updates; a generic ckVision active-block/incremental-layout capability remains open |
